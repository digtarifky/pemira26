      ...
      <CardContent>
        <Tabs default-value="ballots">
          <TabsList class="block w-fit mx-auto">
            ...
            <TabsTrigger v-for="group in groups" :value="`grp${group.id}`">
              {{ group.name }}
            </TabsTrigger>
          ...
          <TabsContent v-for="group in groups" :value="`grp${group.id}`">
            <div class="grid grid-cols-4 gap-4">
              <Card v-for="candidate in group.candidates" class="relative">
                <div
