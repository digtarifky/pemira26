    ...
    <Card class="max-w-screen-md w-full divide-y">
      <div class="flex justify-between gap-4">
        ...
        <CardHeader class="flex-row gap-4">
          <ConfirmationDialog
            v-if="!organization.is_open && organization.ballots_count > 0"
          ...
          >
            <Button
              :variant="organization.ballots_count > 0 ? 'outline' : 'default'"
            >
              Buka Pemilihan
            </Button>
          </ConfirmationDialog>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead class="pr-6 text-right"> Waktu </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
      ...
      <CardFooter class="px-6 py-2 flex items-center justify-between gap-4">
        <Button
      ...
      >
        ...
        <Link
          :href="
            user.type === 'admin' ? route('admin.dashboard') : route('index')
          "
