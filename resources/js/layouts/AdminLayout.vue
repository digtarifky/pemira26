    ...
    <Sidebar collapsible="icon">
          ...
          <SidebarMenuItem>
            ...
            >
              ...
              <div class="grid flex-1 text-left text-sm leading-tight">
                <span class="truncate font-extrabold"> PEMIRA </span>
                <span class="truncate text-xs"> Fakultas Ilmu Komputer </span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarMenu>
            <SidebarMenuItem v-for="organization in page.props.organizations">
              <SidebarMenuButton as-child>
                <Link
                  :href="
            ...
            <SidebarMenuItem v-if="!page.props.organizations?.length">
